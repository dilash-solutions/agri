<nav class="navbar navbar-expand-sm navbar-toggleable-sm  box-shadow mb-0" style="background-color:#000000c2">
            <div class="container ">
                <a class="navbar-brand text-white" style="font-size:90%" href="/dashboard">
                ...
                <div class="navbar-collapse collapse d-sm-inline-flex flex-sm-row-reverse">
                    ...
                    <div class="text-white text-decoration-none mr-3">{{ Auth::user()->name }}</div>
                    ...
                    <form method="POST"  action="{{ route('logout') }}">
                        ...
                        <x-dropdown-link :href="route('logout')"
                                onclick="event.preventDefault();
                                            this.closest('form').submit();" class="text-white text-decoration-none mr-3">
                            {{ __('Logout') }}
                        </x-dropdown-link>
                    </form>
